...
// Total numbered grid positions (14 rows × 22 cols). Matches the iOS
// numbering scheme: spots are identified by grid index 1..308, where
// some indices land on grass islands or light-pole cells and are thus
// not usable parking spots. The usable-spot count (283) is derived at
// runtime by subtracting NOT_A_SPOT_POSITIONS.length + GRASS_POSITIONS.length.
