...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      >
        <svg className="w-5 h-5" fill="none" stroke="var(--text-primary)" viewBox="0 0 24 24" strokeWidth={1.5}>
          {isOpen ? (
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-0 h-full w-[220px] flex flex-col z-40 transition-transform duration-200 md:translate-x-0 ${
